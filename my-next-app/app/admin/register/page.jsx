...
export default function AdminRegisterPage() {
  ...
  const { setLoadingState, setUserState, setEmailState } = userAuthData;
  ...
  function validate() {
    ...
    else if (formValues.name.trim().length < 2) errs.name = 'Name must be at least 2 characters.';
  ...
  async function handleSubmit(e) {
    ...
    setLoading(true);
    try {
    const res = await register(formValues.name, formValues.email, formValues.password, formValues.password);
    if (res && res.success) {
    setSubmitMessage('Registration successful! Please verify your email.');
    setTimeout(() => {
    ...
    <AdminAuthLayout>
      <div className="w-full max-w-md">
        ...
        <h1 className="text-2xl font-extrabold text-center text-gray-900 mb-6 leading-tight">
          ...
          <span className="text-xl">benefits and stay up-to-date.</span>
        </h1>
        ...
        <div className="bg-white border border-gray-200 rounded-xl px-8 py-8 shadow-sm">
          ...
          <div className="flex items-center gap-3 my-4">
            ...
            <span className="text-xs text-gray-400 whitespace-nowrap">Or, Sign Up with your email</span>
            <div className="flex-1 h-px bg-gray-200" />
          </div>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <p className="text-sm text-gray-500 mt-1">
              ...
              <Link href="/admin/login" className="text-teal-600 font-semibold hover:underline">Sign Up</Link>
            </p>
